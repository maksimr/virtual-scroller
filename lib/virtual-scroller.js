...
export class VirtualScroller {
  /**
   * @typedef {{itemCount: number, itemBuilder: function(number):Element, onRemoveItem: function(number)=, itemSize: number=, bufferSize: number=, scrollPosition: number=, horizontal: boolean=}} VirtualScrollerParams
   */
  /**
